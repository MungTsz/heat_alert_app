...
// Builds get_exposure_list API rows from simplified track segments.
// Indoor/outdoor status can't be inferred from GPS alone, so every point is
// sent as "Outdoor" — the API's own server-side point validation already
