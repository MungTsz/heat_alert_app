...
const AddBookmarkModal = ({ visible, onClose, onAdd }: Props) => {
  ...
  const [type, setType] = useState<BookmarkType>('place');
  ...
  useEffect(() => {
    if (
      ...
      coords &&
      locationText &&
      !['Locating...', 'Unavailable', 'Permission denied', 'Error'].includes(
        locationText,
      )
    ) {
    ...
    >
      <View style={styles.overlay}>
        ...
        >
          ...
          <View style={styles.typeRow}>
            ...
            >
              <Text
                style={[
                  styles.typeText,
                  type === 'house' && styles.typeTextActive,
                ]}
              >
                House
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.typeButton,
                type === 'place' && styles.typeButtonActive,
              ]}
            ...
            >
              <Text
                style={[
                  styles.typeText,
                  type === 'place' && styles.typeTextActive,
                ]}
              >
                Place
              </Text>
          ...
          <TextInput
            style={styles.input}
            placeholder="Name (e.g. Mom's House, Local Park)"
            value={label}
...
const styles = StyleSheet.create({
  ...
  typeButtonActive: { backgroundColor: '#D9534F', borderColor: '#D9534F' },
  ...
  inlineLoadingHint: { position: 'absolute', right: 14, top: 12 },
  suggestionBox: {
    borderWidth: 1,
    borderColor: '#eee',
    borderRadius: 10,
  ...
  error: { color: '#D9534F', fontSize: 13, marginBottom: 8 },
  buttonRow: {
    flexDirection: 'row',
